...
|-----------------------------|--------|
| `skills/argo-argocd-mcp/SKILL.md` | Your ArgoCD MCP + Archivist workflow |
...
|--------|----------|---------|
| `argocd` | `http://192.168.11.160:8080/argocd/mcp` | ArgoCD apps, sync, health, rollback via mcp-aggregator |
...
mcp-call argocd argocd_list_applications '{}'
mcp-call argocd argocd_get_application '{"name":"my-app"}'
mcp-call argocd argocd_sync_application '{"name":"my-app"}'
mcp-call argocd argocd_get_application_history '{"name":"my-app"}'
```
...
mcp-call archivist archivist_store '{"agent_id":"argo","namespace":"deployer","text":"App frontend synced rev abc123","tags":["sync","frontend"]}'
